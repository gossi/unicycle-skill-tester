...
class InsertController implements IController {
	...
	private function createActions() {
		...
		$a->setDescription('Die Geschwindigkeit gemessen an den Umdrehungen pro Minute');
		$a->save();
		...
		// 32
		$a = new Action();
		$a->setTitle('Reifen und hinter den Fußballen auf der Gabel');
		...
		// 33
		$a = new Action();
		$a->setTitle('Reifen und mit der Ferse auf der Gabel');
