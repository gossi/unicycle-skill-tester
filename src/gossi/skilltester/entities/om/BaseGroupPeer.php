...
use gossi\skilltester\entities\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'gossi\\skilltester\\entities\\Group';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, ),
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(GroupI18nPeer::ID, $obj->getId());
            $affectedRows += GroupI18nPeer::doDelete($criteria, $con);
        }
