...
abstract class BaseItem extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'gossi\\skilltester\\entities\\ItemPeer';
    ...
    public function setTrickId($v)
    {
        ...
        if ($this->trick_id !== $v) {
            $this->trick_id = $v;
            $this->modifiedColumns[] = ItemPeer::TRICK_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = ItemPeer::GROUP_ID;
        }
    ...
    public function setActionId($v)
    {
        ...
        if ($this->action_id !== $v) {
            $this->action_id = $v;
            $this->modifiedColumns[] = ItemPeer::ACTION_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ItemPeer::TRICK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`trick_id`';
        }
        if ($this->isColumnModified(ItemPeer::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }
        if ($this->isColumnModified(ItemPeer::ACTION_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Item'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Item'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ItemPeer::TRICK_ID)) $criteria->add(ItemPeer::TRICK_ID, $this->trick_id);
        if ($this->isColumnModified(ItemPeer::GROUP_ID)) $criteria->add(ItemPeer::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(ItemPeer::ACTION_ID)) $criteria->add(ItemPeer::ACTION_ID, $this->action_id);
    ...
    {
        $criteria = new Criteria(ItemPeer::DATABASE_NAME);
        $criteria->add(ItemPeer::TRICK_ID, $this->trick_id);
        $criteria->add(ItemPeer::GROUP_ID, $this->group_id);
        $criteria->add(ItemPeer::ACTION_ID, $this->action_id);
