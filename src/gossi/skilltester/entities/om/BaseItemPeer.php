...
use gossi\skilltester\entities\map\ItemTableMap;
...
abstract class BaseItemPeer
{
    ...
    const OM_CLASS = 'gossi\\skilltester\\entities\\Item';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ItemPeer::TRICK_ID, ItemPeer::GROUP_ID, ItemPeer::ACTION_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ItemPeer::TRICK_ID => 0, ItemPeer::GROUP_ID => 1, ItemPeer::ACTION_ID => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ItemPeer::TRICK_ID);
            $criteria->addSelectColumn(ItemPeer::GROUP_ID);
            $criteria->addSelectColumn(ItemPeer::ACTION_ID);
        } else {
    ...
    public static function doCountJoinTrick(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ItemPeer::TRICK_ID, TrickPeer::ID, $join_behavior);
    ...
    public static function doCountJoinGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ItemPeer::GROUP_ID, GroupPeer::ID, $join_behavior);
    ...
    public static function doCountJoinAction(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ItemPeer::ACTION_ID, ActionPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Item objects pre-filled with their Trick objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinTrick(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Item) to $obj2 (Trick)
                $obj2->addItem($obj1);
    ...
    /**
     * Selects a collection of Item objects pre-filled with their Group objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Item objects.
    ...
    public static function doSelectJoinGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Item) to $obj2 (Group)
                $obj2->addItem($obj1);
    ...
    /**
     * Selects a collection of Item objects pre-filled with their Action objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Item objects.
    ...
    public static function doSelectJoinAction(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Item) to $obj2 (Action)
                $obj2->addItem($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Item) to the collection in $obj2 (Trick)
                $obj2->addItem($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Item) to the collection in $obj3 (Group)
                $obj3->addItem($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Item) to the collection in $obj4 (Action)
                $obj4->addItem($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Item objects pre-filled with all related objects except Trick.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptTrick(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = ItemPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Item) to the collection in $obj2 (Group)
                $obj2->addItem($obj1);
                ...
                // Add the $obj1 (Item) to the collection in $obj3 (Action)
                $obj3->addItem($obj1);
    ...
    /**
     * Selects a collection of Item objects pre-filled with all related objects except Group.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Item objects pre-filled with all related objects except Action.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ItemPeer::TRICK_ID);
            $value = $criteria->remove(ItemPeer::TRICK_ID);
            if ($value) {
                $selectCriteria->add(ItemPeer::TRICK_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ItemPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(ItemPeer::GROUP_ID);
            $value = $criteria->remove(ItemPeer::GROUP_ID);
            if ($value) {
                $selectCriteria->add(ItemPeer::GROUP_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ItemPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(ItemPeer::ACTION_ID);
            $value = $criteria->remove(ItemPeer::ACTION_ID);
            if ($value) {
                $selectCriteria->add(ItemPeer::ACTION_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ItemPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(ItemPeer::TRICK_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(ItemPeer::GROUP_ID, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(ItemPeer::ACTION_ID, $value[2]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                ItemPeer::removeInstanceFromPool($value);
            }
        }
    ...
    public static function retrieveByPK($trick_id, $group_id, $action_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $trick_id, (string) $group_id, (string) $action_id));
         if (null !== ($obj = ItemPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(ItemPeer::DATABASE_NAME);
        $criteria->add(ItemPeer::TRICK_ID, $trick_id);
        $criteria->add(ItemPeer::GROUP_ID, $group_id);
        $criteria->add(ItemPeer::ACTION_ID, $action_id);
