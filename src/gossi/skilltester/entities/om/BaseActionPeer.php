...
use gossi\skilltester\entities\map\ActionTableMap;
...
abstract class BaseActionPeer
{
    ...
    const OM_CLASS = 'gossi\\skilltester\\entities\\Action';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ActionPeer::ID, ActionPeer::TYPE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ActionPeer::ID => 0, ActionPeer::TYPE => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ActionPeer::TYPE);
        } else {
    ...
    {
        // Invalidate objects in ActionI18nPeer instance pool,
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += ActionPeer::doOnDeleteCascade(new Criteria(ActionPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += ActionPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = ActionPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related ActionI18n objects
            $criteria = new Criteria(ActionI18nPeer::DATABASE_NAME);

            $criteria->add(ActionI18nPeer::ID, $obj->getId());
            $affectedRows += ActionI18nPeer::doDelete($criteria, $con);
        }
